...
INSERT INTO "new_User" ("committeeRole", "createdAt", "displayName", "id", "lineId", "passwordHash", "phoneNumber", "role", "scopeDistrictId", "scopeProvinceId", "scopeSubDistrictId", "scopeVillageId", "username") SELECT "committeeRole", "createdAt", "displayName", "id", "lineId", "passwordHash", "phoneNumber", "role", "scopeDistrictId", "scopeProvinceId", "scopeSubDistrictId", "scopeVillageId", "username" FROM "User";
DROP TABLE "User";
