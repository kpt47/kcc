...
-- ครัวเรือน/ผู้ใช้เดิมที่ยังไม่มีเบอร์โทรศัพท์ (phoneNumber เดิมเป็น NULL ได้) ให้ใส่ค่า placeholder ชั่วคราวไว้ก่อน
-- ผู้ดูแลระบบ/สคริปต์ seed ต้องเข้าไปแก้ไขเป็นเบอร์จริงภายหลัง (ดู prisma/seed.ts ที่อัปเดตให้มีเบอร์จริงสำหรับบัญชีทดสอบ)
INSERT INTO "new_User" ("committeeRole", "createdAt", "householdId", "id", "isActive", "lineId", "passwordHash", "phoneNumber", "role", "scopeDistrictId", "scopeProvinceId", "scopeSubDistrictId", "scopeVillageId", "username") SELECT "committeeRole", "createdAt", "householdId", "id", "isActive", "lineId", "passwordHash", COALESCE("phoneNumber", '0000000000'), "role", "scopeDistrictId", "scopeProvinceId", "scopeSubDistrictId", "scopeVillageId", "username" FROM "User";
DROP TABLE "User";
