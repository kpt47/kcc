...
/**
 * แก้ไข/ลบข้อมูล "แบบเสนอโครงการ"/"แบบขอยืมเงินทุน" ได้แม้กระบวนการดำเนินไปแล้ว (ต่างจากครัวเรือนที่แก้ไขได้
 * เฉพาะก่อนพัฒนากรให้ความเห็นเท่านั้น ดู PATCH /api/proposals/[id]) — เฉพาะพัฒนาการอำเภอ พัฒนากรตำบล และ
 * ประธานคณะกรรมการหมู่บ้าน เผื่อกรณีต้องแก้ไขข้อมูลที่กรอกผิดพลาดหรือลบรายการที่ยื่นซ้ำ/ผิดพลาด — ไม่ครอบคลุม
 * ถึงการแก้ไขความเห็นพัฒนากร/ผลอนุมัติ ซึ่งมี endpoint เฉพาะ (worker-opinion, approve) แยกสิทธิ์ไว้อยู่แล้ว
 */
export function canManageProposalOrLoanRequestRecord(user: Pick<CurrentUser, "role" | "committeeRole">): boolean {
